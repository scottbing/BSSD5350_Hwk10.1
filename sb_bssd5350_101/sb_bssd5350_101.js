...
function allRandom(pixelSize, SCALES) {
  rectMode(CENTER)
  createCanvas(img.width, img.height)
  for (x = 0; x < img.width; x+=pixelSize) {
    for (y = 0; y < img.height; y+=pixelSize) { 
...
function firstPass(pixelSize, SCALES, negativePallette) { 
  rectMode(CENTER)
  createCanvas(img.width, img.height)
  for (x = 0; x < img.width; x+=pixelSize) {
    for (y = 0; y < img.height; y+=pixelSize) { 
